...
**2-** DualDA substitutes the final layer of the original model with a <img src="img/text-2.png" height="13em" style="vertical-align: middle;">. The resulting weight vector <img src="img/text-3.png" height="13em" style="vertical-align: middle;"> can then be expressed as a linear combination of the final layer <img src="img/text-4.png" height="13em" style="vertical-align: middle;"> of training samples. Note that a binary classification case is visualized for the sake of simplicity and legibility, whereas DualDA employs a multiclass SVM.

**3-** The <img src="img/text-5.png" height="13em" style="vertical-align: middle;"> of each training datapoint is quantified by its corresponding scalar coefficient <img src="img/text-6.png" height="13em" style="vertical-align: middle;"> in the linear decomposition of <img src="img/text-3.png" height="13em" style="vertical-align: middle;">.
