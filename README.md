...
DualDA efficiently identifies training samples which are influential for both the overall model fit ( <img src="img/text-0.png" height="13em" style="vertical-align: middle;">  ) as well as for the prediction for specific test samples  (  <img src="img/text-1.png" height="13em" style="vertical-align: middle;">  ).

**1-** Our method assumes models with a nonlinear <img src="img/text-2.png" height="13em" style="vertical-align: middle;"> followed by a fully-connected layer as the <img src="img/text-3.png" height="13em" style="vertical-align: middle;"> .

**2-** DualDA substitutes the final layer of the original model with a <img src="img/text-4.png" height="13em" style="vertical-align: middle;">. The resulting weight vector <img src="img/text-5.png" height="13em" style="vertical-align: middle;"> can then be expressed as a linear combination of the final layer  latent features of training samples. Note that a binary classification case is visualized for the sake of simplicity and legibility, whereas DualDA employs a multiclass SVM.

**3-** The <img src="img/text-0.png" height="13em" style="vertical-align: middle;"> of each training datapoint is quantified by its corresponding scalar coefficient (  <img src="img/text-6.png" height="13em" style="vertical-align: middle;">  ) in the linear decomposition of <img src="img/text-5.png" height="13em" style="vertical-align: middle;">.

**4-** Moreover, since <img src="img/text-5.png" height="13em" style="vertical-align: middle;"> is represented as a combination of training feature embeddings, we can decompose the output of the surrogate model for a given test point into a sum of contributions from each training sample.
This <img src="img/text-1.png" height="13em" style="vertical-align: middle;"> is given by the inner product of the feature embeddings of the training and test samples, scaled by the global influence coefficient of the training sample.
